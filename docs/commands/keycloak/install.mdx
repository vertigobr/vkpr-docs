...
- `openid`
  - `grafana`
    ...
    - `clientSecret` - (Optional) Specifies the Client Secret from Client ID used. The default is a random UUID.
    - `identityProviders` - (Optional) Specifies which IdP will use. Allowed Values: Google, Github
  - `kong`
