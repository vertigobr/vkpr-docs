---
sidebar_position: 2
sidebar_label: VKPR external-dns install digitalocean
title: VKPR external-dns install digitalocean
---
...
Instala o external-dns para Digital Ocean no cluster. Para mais informações sobre o external-dns, clique [aqui](https://github.com/kubernetes-sigs/external-dns).
