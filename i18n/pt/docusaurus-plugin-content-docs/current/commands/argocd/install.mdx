...
- `addons`
  - `notifications` 
    - `enabled` - (Opcional) Instala o [Argo Notifications](https://argocd-notifications.readthedocs.io/en/stable/) no cluster.
  - `rollouts` 
    - `enabled` - (Opcional) Instala o [Argo Rollouts](https://argoproj.github.io/argo-rollouts/) no cluster.
  - `events` 
    - `enabled` - (Opcional) Instala o [Argo Events](https://argoproj.github.io/argo-events/) no cluster.
  - `workflows` 
    - `enabled` (Opcional) Instala o [Argo Workflows](https://argoproj.github.io/argo-workflows/) no cluster.
