...
- `existingClaim` - (Opcional) Escpecífica uma PVC existente para associar ao Postgresql.
- `persistanceSize` - (Opcional) Especifica o tamanho do volume que será usado para o aplicativo armazenar seu conteúdo. O valor padrão é `8Gi`
